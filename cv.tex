...
\subsection*{Conference Proceedings}
 ...
 Kim-Manuel\footnote{This author was a Ph.\,D.~student at time of writing\label{note_phd}}
...
\years{2017b}Bannach, Max\footref{note_phd} and Berndt, Sebastian and Ehlers, Thorsten\footref{note_phd} (2017),\\
"Jdrasil: A Modular Library for Computing Tree Decompositions",
\emph{SEA 2017}\\
\years{2017c}Berndt, Sebastian and Liśkiewicz, Maciej (2017),\\
"Algorithm Substitution Attacks from a Steganographic Perspective",
\emph{CCS 2017}\\
\years{2018a} Berndt, Sebastian and Liśkiewicz, Maciej (2018),\\
...
\years{2018d} Bannach, Max\footref{note_phd} and Berndt, Sebastian  (2018),\\
"Practical Access to Dynamic Programming on Tree Decompositions", \emph{ESA
  2018}\\
\textbf{Awarded Best Student Paper (Track B)}\\
\years{2019a} Bannach, Max\footref{note_phd} and Berndt, Sebastian (2019),\\
...
Asaf and Maack, Marten\footref{note_phd} and Rohwedder, Lars\footref{note_phd} (2019),\\
...
Jansen, Klaus  and\\ Knof, Ingmar\footref{note_msc} (2019),\\
...
(Kiel)\\
- Lecturer for "Introduction to Math for Dual-Subject Students" in 2018 teaching and designing the lectures (Kiel)
...
\years{2019b}Bachelor Thesis on "Deterministic Algorithms for Discrepancy Minimization"\\
...
\emph{SODA}, \emph{ESA}, \emph{ICALP}, \emph{ISAAC}, \emph{STACS}, \emph{IPDPS}, \emph{ALT}, \emph{WG},
...
\emph{JEA}, \emph{Journal of Combinatorial Optimization}

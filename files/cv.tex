...
\subsection*{Conference Proceedings}
 ...
 Kim-Manuel\footnote{This author was a Ph.\,D.~student at time of
   writing\label{note_phd}}\footnote{The authors are alphabetically sorted\label{note_sort}}
...
\years{2017a}Berndt, Sebastian and Liśkiewicz, Maciej and Lutter, Matthias\footref{note_phd}\footref{note_sort}
...
"Robust Online Algorithms for Certain Dynamic Packing Problems", \emph{WAOA 2019}
...
\emph{SODA}, \emph{CRYPTO}, \emph{EUROCRYPT}, \emph{ESA}, \emph{ICALP}, \emph{STACS}, \emph{ISAAC}, \emph{IPDPS}, \emph{ALT}, \emph{WG},
